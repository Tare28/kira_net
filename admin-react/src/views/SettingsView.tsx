                            ...
                            <div key={i} style={{ background: 'white', padding: '24px', borderRadius: '20px', border: '1px solid #F1F5F9', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
                                    ...
                                    <div className="show-mobile" style={{ display: 'none' }}>
                                        <h4 style={{ fontSize: '14px', fontWeight: 800 }}>{f.label}</h4>
                                    </div>
                                </div>
                                <div 
                    ...
                    <div style={{ background: 'white', padding: '32px', borderRadius: '24px', border: '1px solid #F1F5F9' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                            <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                                ...
                                <span style={{ fontSize: '15px', fontWeight: 800 }}>Advanced Logic</span>
                            </div>
                            <ChevronDown size={18} color="#64748B"/>
                        </div>
                        <div style={{ background: '#0F172A', padding: '24px', borderRadius: '12px', marginBottom: '24px', fontFamily: 'monospace', fontSize: '12px', color: '#4ADE80', lineHeight: 2, overflowX: 'auto' }}>
                            // CACHE_FLUSH: 3600s<br/>
                            // API_LIMIT: 150/hr<br/>
                            // DEBUG: FALSE
                        </div>
